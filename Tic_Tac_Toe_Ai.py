...
class TIC_TAC_TOE_AI:
    ...
    def decorating(self):# Basic Set-up
        Label(self.make_canvas, text="Smart Game By Mohit", bg="#141414", fg="#00FF00", font=("Lato", 25, "bold")).place(x=80, y=10)
        ...
        self.machine_first_control = Button(self.make_canvas, text="AI vs Player", font=("Arial", 15, "bold", "italic"), bg="#262626", activebackground="#262626", fg="#9d9dff", relief=RAISED, bd=3, command=lambda: self.control_give("machine_first"))
        self.machine_first_control.place(x=15, y=380)

        self.human_first_control = Button(self.make_canvas, text="Player vs AI", font=("Arial", 15, "bold", "italic"), bg="#262626", activebackground="#262626", fg="#9d9dff", relief=RAISED, bd=3, command=self.control_give)
    ...
    def control_give(self, indicator="human_first"):# Control give based on human first or computer first play
        self.machine_first_control.config(state=DISABLED, disabledforeground="yellow")
        self.human_first_control.config(state=DISABLED, disabledforeground="yellow")
        self.reset_btn.config(state=DISABLED, disabledforeground="yellow")
        for every in self.activate_btn:
...
if __name__ == "__main__":
    window = Tk()
    window.title("Smart Game By Mohit")
